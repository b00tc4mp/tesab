...
function ContactForm() {
    ...
    return <div className="m-6">
            <h2 className="font-bakbak-one text-2xl my-6 text-center">Contacte con un experto </h2>
            ...
            <p><input id="checkbox1" type="checkbox" />Me gustaría recibir las noticias quincenales gratuitas de Tesab Spain en mi correo electrónico.</p>
