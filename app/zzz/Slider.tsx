...
/**
 * Slider (made with honour by us ;)
 * 
 * @example
 * 
 * ```ts
 * <Slider isMobile={isMobile} width={500} height={300}>
 *      <video className="w-full" autoPlay loop muted src="https://tesab-heavy.surge.sh/equipment/crushers/800i/800iVideo.mp4" type="video/mp4" />
 *      <img className="w-full" src="https://tesab-heavy.surge.sh/equipment/crushers/700i.jpeg" />
 *      <img className="w-full" src="https://tesab-heavy.surge.sh/equipment/crushers/700i.jpeg" />
 *      <img className="w-full" src="https://tesab-heavy.surge.sh/equipment/crushers/700i.jpeg" />
 * </Slider>
 * ```
